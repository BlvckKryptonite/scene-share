...
urlpatterns = [
    ...
    path(
        ...
        name='remove_from_watchlist_tmdb'
    ),
    path(
        'watchlist/remove/local/<int:movie_id>/',
        views.remove_from_watchlist,
        name='remove_from_watchlist_local'
    ),
    path(
        'watchlist/toggle/tmdb/<int:tmdb_id>/',
        views.toggle_watched,
        name='toggle_watched_tmdb'
    ),
    path(
        'watchlist/toggle/local/<int:movie_id>/',
        views.toggle_watched,
        name='toggle_watched_local'
    ),
